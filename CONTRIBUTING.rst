...
Welcome to ``class_projects`` contributor's guide.
...
If you experience bugs or general issues with ``class_projects``, please have a look
...
You can help improve ``class_projects`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``class_projects`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``class_projects``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n class_projects python=3 six virtualenv pytest pytest-cov
    conda activate class_projects
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/class_projects.git
    cd class_projects
...
#. Install |pre-commit|_::
   ...
   ``class_projects`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/class_projects
.. _issue tracker: https://github.com/<USERNAME>/class_projects/issues
.. <-- end -->
